...
?>
 ...
 <!--Menu de Categorias -->
  ...
  <div class="conteudo">
  <?php
   $seleprod=mysqli_query($conn,"SELECT * FROM produto where cat_prod = $id");
       

   while($lsprod=mysqli_fetch_array($seleprod)){
  ?>
  <div class="produto">
	  
	  <img src="img/produtos/<?php echo $lsprod['img_prod'];?>" class="imgprod">
	  <br>
	  <span class="tituprod"><?php echo $lsprod['nome_prod']; ?> </span><br>
	  
	  <span class="tituprod">Valor: R$<?php echo $lsprod['valor_prod']; ?> </span>
	  <br>
	  <a href="#" class="enviar" style="position:relative; right:13px; font-size:25px;">Comprar</a>
